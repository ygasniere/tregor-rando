...
interface DataApi {
    ...
    fun getHikes(): Call<fr.enssat.tregorrando.gasniere_lefort.data.json.ListResponse>
...
class DataFetcher {
    ...
    fun fetchHikes(callback: (List<Types>) -> Unit) {
        dataApi.getHikes().enqueue(object: Callback<fr.enssat.tregorrando.gasniere_lefort.data.json.ListResponse> {
